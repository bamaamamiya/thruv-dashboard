...
const ProfitTotal = ({ totalSales, totalCost , totalPendingValue , totalReturnToSenderCost , pendingCost}) => {
  // Hitung profit
  const profit = totalSales + totalPendingValue - totalCost - totalReturnToSenderCost - pendingCost;
